...
(function (root, factory) {
  ...
  return [
    ...
    { id: 'shopping', minLevel: 2, title: '买东西', en: 'Shopping and bargaining', persona: 'a market stall owner', setting: 'a clothes market', goal: 'Ask about size and colour, ask the price, and bargain it down.',
      opener: { zh: '老板娘在这儿！你想买什么？这件衣服很漂亮。', p: 'Lǎobǎnniáng zài zhèr! Nǐ xiǎng mǎi shénme? Zhè jiàn yīfu hěn piàoliang.', en: 'The owner is here! What would you like to buy? This piece is very pretty.' } },
    ...
    { id: 'doctor', minLevel: 3, title: '看医生', en: 'At the doctor', persona: 'a calm doctor', setting: 'a clinic', goal: 'Describe your symptoms, answer the doctor’s questions, and understand the advice.',
      opener: { zh: '请坐。你哪儿不舒服？', p: 'Qǐng zuò. Nǐ nǎr bù shūfu?', en: 'Please sit down. Where do you feel unwell?' } },
    ...
    /* ---------- Business track: cross-border PE / VC ---------- */
    { id: 'biz-intro', track: 'business', minLevel: 2, title: '初次见面', en: 'First meeting with a Chinese GP', persona: '王总 (Wáng zǒng), managing partner of a Shanghai growth fund', setting: 'a conference lounge in Shanghai', goal: 'Introduce yourself and your fund, exchange cards, and propose a follow-up meeting.',
      opener: { zh: '您好，我是王磊，很高兴认识您。您是哪家基金的？', p: 'Nín hǎo, wǒ shì Wáng Lěi, hěn gāoxìng rènshi nín. Nín shì nǎ jiā jījīn de?', en: 'Hello, I am Wang Lei, pleased to meet you. Which fund are you with?' } },
    { id: 'biz-lp', track: 'business', minLevel: 3, title: '向出资人路演', en: 'Pitch a Chinese LP', persona: '张总 (Zhāng zǒng), CIO of a family office in Hangzhou', setting: 'a private meeting room', goal: 'Present your fund’s size, strategy, track record and terms, and handle questions on fees and returns.',
      opener: { zh: '张总让我先听听你们基金的情况。你们这期规模多大，主要投什么赛道？', p: 'Zhāng zǒng ràng wǒ xiān tīngting nǐmen jījīn de qíngkuàng. Nǐmen zhè qī guīmó duō dà, zhǔyào tóu shénme sàidào?', en: 'Mr Zhang asked me to hear about your fund first. How big is this vintage, and which sectors do you back?' } },
    { id: 'biz-terms', track: 'business', minLevel: 3, title: '谈条款', en: 'Negotiate the term sheet', persona: '李总 (Lǐ zǒng), founder of a Shenzhen robotics company', setting: 'the founder’s office', goal: 'Agree valuation, liquidation preference, board seat and an exclusivity period without losing the founder’s goodwill.',
      opener: { zh: '你们的条款清单我看了。估值太低了，而且我不太能接受一票否决权。', p: 'Nǐmen de tiáokuǎn qīngdān wǒ kàn le. Gūzhí tài dī le, érqiě wǒ bú tài néng jiēshòu yí piào fǒujuéquán.', en: 'I have read your term sheet. The valuation is too low, and I cannot really accept a veto right.' } },
    { id: 'biz-dd', track: 'business', minLevel: 3, title: '尽调电话', en: 'Due diligence call with the CFO', persona: '陈总 (Chén zǒng), CFO of the target company', setting: 'a video call', goal: 'Ask about revenue, margins, receivables, related-party transactions and the data room; probe politely when answers are vague.',
      opener: { zh: '数据室已经开放了。你们财务尽调主要想了解哪些方面？', p: 'Shùjùshì yǐjīng kāifàng le. Nǐmen cáiwù jìndiào zhǔyào xiǎng liǎojiě nǎxiē fāngmiàn?', en: 'The data room is open. Which areas does your financial diligence focus on?' } },
    { id: 'biz-closing', track: 'business', minLevel: 3, title: '交割', en: 'Close the deal: CPs, escrow and wire', persona: '赵律师 (Zhào lǜshī), counsel for the seller', setting: 'a closing call with both law firms', goal: 'Walk through outstanding conditions precedent, the ODI filing, escrow release and the exchange rate, and fix a closing date.',
      opener: { zh: '我们过一下交割清单吧。目前还有哪些条件没有满足？', p: 'Wǒmen guò yíxià jiāogē qīngdān ba. Mùqián hái yǒu nǎxiē tiáojiàn méiyǒu mǎnzú?', en: 'Let’s go through the closing checklist. Which conditions are still outstanding?' } },
    { id: 'biz-banquet', track: 'business', minLevel: 2, title: '饭局', en: 'The closing dinner', persona: '王总 and his team at a private dining room', setting: 'a banquet after signing', goal: 'Toast correctly, thank the other side, decline a drink gracefully, and lock in the long-term relationship.',
      opener: { zh: '来来来，签约成功，我先敬你一杯！', p: 'Lái lái lái, qiānyuē chénggōng, wǒ xiān jìng nǐ yì bēi!', en: 'Come, come — the signing is done, let me toast you first!' } }
  ];
});
