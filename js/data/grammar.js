...
(function (root, factory) {
  ...
  return [
    ...
    /* ---------- HSK 5 ---------- */
    { level: 5, name: '与其…不如…', pattern: '与其 A，不如 B', zh: '与其在家等，不如出去找他。', p: 'Yǔqí zài jiā děng, bùrú chūqù zhǎo tā.', en: 'Rather than wait at home, better go out and find him.', note: 'Prefers B over A. 不如 alone also means “not as good as”: 我不如他.' },
    { level: 5, name: '宁可…也…', pattern: '宁可 A，也不 / 也要 B', zh: '我宁可走路，也不坐他的车。', p: 'Wǒ nìngkě zǒulù, yě bú zuò tā de chē.', en: 'I would rather walk than ride in his car.', note: 'A firm preference, accepting a cost.' },
    { level: 5, name: '之所以…是因为…', pattern: 'A 之所以 B，是因为 C', zh: '他之所以成功，是因为他从不放弃。', p: 'Tā zhīsuǒyǐ chénggōng, shì yīnwèi tā cóngbù fàngqì.', en: 'The reason he succeeded is that he never gave up.', note: 'States the result first, then the reason; written and formal-spoken style.' },
    { level: 5, name: '尽管…还是…', pattern: '尽管 A，还是 / 仍然 B', zh: '尽管很困难，他还是坚持下来了。', p: 'Jǐnguǎn hěn kùnnan, tā háishi jiānchí xiàlai le.', en: 'Despite the difficulty, he still held on.', note: 'A stronger, more formal 虽然. 尽管 also means “feel free to”: 尽管说.' },
    { level: 5, name: '凡是…都…', pattern: '凡是 + noun，都 + verb', zh: '凡是参加的人都有礼物。', p: 'Fánshì cānjiā de rén dōu yǒu lǐwù.', en: 'Everyone who takes part gets a gift.', note: '“All those who…”; pairs with 都.' },
    { level: 5, name: '不是…而是…', pattern: '不是 A，而是 B', zh: '问题不是钱，而是时间。', p: 'Wèntí bú shì qián, érshì shíjiān.', en: 'The problem isn’t money, it’s time.', note: 'Corrects a wrong assumption. Compare 不是…就是… (“either… or”).' },
    { level: 5, name: '再…也…', pattern: '再 + adjective / verb，也 + …', zh: '再难，我也要学会。', p: 'Zài nán, wǒ yě yào xuéhuì.', en: 'However hard it is, I will learn it.', note: '“No matter how…”; the 再 clause states the extreme, 也 the unchanged result.' },
    { level: 5, name: '难道…吗', pattern: '难道 … 吗？', zh: '难道你不知道吗？', p: 'Nándào nǐ bù zhīdào ma?', en: 'Don’t tell me you didn’t know?', note: 'A rhetorical question expressing surprise or reproach.' },
    { level: 5, name: 'Verb reduplication with 一', pattern: 'verb + 一 + verb', zh: '让我看一看。', p: 'Ràng wǒ kàn yi kàn.', en: 'Let me have a look.', note: 'Softens the action; same as 看看 / 看一下.' },
    { level: 5, name: '把 with 成 / 作', pattern: '把 A + 当作 / 看作 / 变成 B', zh: '我把他当作最好的朋友。', p: 'Wǒ bǎ tā dàngzuò zuì hǎo de péngyou.', en: 'I regard him as my best friend.', note: 'Result complements of transformation and regard.' },
    { level: 5, name: '以…为…', pattern: '以 A 为 B', zh: '这个公司以客户为中心。', p: 'Zhè ge gōngsī yǐ kèhù wéi zhōngxīn.', en: 'This company puts the customer at the centre.', note: 'Formal “take A as B”: 以…为主 (mainly), 以…为例 (for example).' },
    { level: 5, name: '一方面…另一方面…', pattern: '一方面 A，另一方面 B', zh: '一方面要工作，另一方面要照顾家庭。', p: 'Yì fāngmiàn yào gōngzuò, lìng yì fāngmiàn yào zhàogù jiātíng.', en: 'On one hand there is work, on the other the family to care for.', note: 'Balances two aspects of one situation.' },
    /* ---------- HSK 6 ---------- */
    { level: 6, name: '固然…但是…', pattern: '固然 A，但是 B', zh: '这个办法固然好，但是成本太高。', p: 'Zhè ge bànfǎ gùrán hǎo, dànshì chéngběn tài gāo.', en: 'This method is admittedly good, but the cost is too high.', note: 'Concedes a point before the real argument; formal.' },
    { level: 6, name: '哪怕…也…', pattern: '哪怕 A，也 B', zh: '哪怕只有一点希望，我们也不放弃。', p: 'Nǎpà zhǐyǒu yìdiǎn xīwàng, wǒmen yě bú fàngqì.', en: 'Even if there is only a sliver of hope, we won’t give up.', note: 'Colloquial 即使, often with 一点 / 一个 to stress the minimum.' },
    { level: 6, name: '以免 / 免得', pattern: 'A，以免 / 免得 B', zh: '早点出发，以免堵车。', p: 'Zǎo diǎn chūfā, yǐmiǎn dǔchē.', en: 'Leave early to avoid the traffic.', note: '“So as not to”; 免得 is the spoken form.' },
    { level: 6, name: '不管…还是…', pattern: '不管 A 还是 B，都…', zh: '不管成功还是失败，都值得尝试。', p: 'Bùguǎn chénggōng háishi shībài, dōu zhíde chángshì.', en: 'Whether it succeeds or fails, it is worth trying.', note: 'Two alternatives that make no difference to the result.' },
