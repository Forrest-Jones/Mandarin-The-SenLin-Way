...
(function (root, factory) {
  ...
  return [
    ...
    { level: 4, name: '被 with 给', pattern: 'A + 被 / 让 / 叫 + B + 给 + verb', zh: '我的自行车让人给偷了。', p: 'Wǒ de zìxíngchē ràng rén gěi tōu le.', en: 'My bicycle got stolen by someone.', note: '让 and 叫 are colloquial passives; the extra 给 is common in speech and changes nothing.' },
