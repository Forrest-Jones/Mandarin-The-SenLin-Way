...
| file | route |
| --- | --- |
| `today.png` | `#/` — the Today page with the 10-minute lesson card |
| `levels.png` | `#/levels` — HSK 1 to 6 timeline |
| `business.png` | `#/business` — Deal Desk |
| `talk.png` | `#/talk` — the live tutor |
